...
class CNN(nn.Module):
    def __init__(self, input_size):
        ...
        self.flatten_size = 64 * input_size
...
def train_and_evaluate_cnn(df, feature_cols=None, train_size=0.7, val_size=0.1, test_size=0.2, 
    ...
    model = CNN(input_size=len(feature_cols)).to(device)
...
if __name__ == "__main__":
    ...
    model, metrics = train_and_evaluate_cnn(df)