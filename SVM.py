...
def train_and_evaluate_svm(df, feature_cols=None, kernel='linear', train_size=0.7, val_size=0.1, test_size=0.2):
...
model, metrics = train_and_evaluate_svm(df, kernel='rbf')
